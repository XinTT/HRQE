...
def filter_wiki_qualfacts():
	...
	for line in line2:
		line = line.strip().split(',')
		if len(line) > 3:
			temp1.append(','.join(line))
	
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wikipeople_qual/valid.txt','w') as f:
		for line in temp:
			f.write(line+'\n')
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wikipeople_qual/test.txt','w') as f:
		for line in temp1:
			f.write(line+'\n')

def filter_wd50k_qualfacts():
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wd50k/valid.txt','r') as f:
		line1 = f.readlines()
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wd50k/test.txt','r') as f:
		line2 = f.readlines()	
	temp = []
	for line in line1:
		line = line.strip().split(',')
	...
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wd50k_qual/valid.txt','w') as f:
		for line in temp:
			f.write(line+'\n')
	with open('/export/data/kb_group_shares/wd50k/StarE-master/data/wd50k_qual/test.txt','w') as f:
		for line in temp1:
			f.write(line+'\n')
